...
class GrowthStepMovpe1IMEM(GrowthStepMovpeIMEM):
    """
    Class autogenerated from yaml schema.
    """
    ...
    #     super(GrowthStepMovpe1IMEM, self).normalize(archive, logger)
...
class GrowthStepMovpe2IMEM(GrowthStepMovpeIMEM):
    """
    Class autogenerated from yaml schema.
    """
...
class GrowthMovpe1IMEMConstantParameters(Process, EntryData, TableData):
    """
    Class autogenerated from yaml schema.
    """
    ...
    steps = SubSection(
        section_def=GrowthStepMovpe1IMEM,
        repeats=True,
    )


class GrowthMovpe1IMEMConstantParametersReference(ActivityReference):
    """
    A section used for referencing a GrowthMovpe1IMEMConstantParameters.
    """
    ...
    reference = Quantity(
        type=GrowthMovpe1IMEMConstantParameters,
        description="A reference to a NOMAD `GrowthMovpe1IMEMConstantParameters` entry.",
        a_eln=ELNAnnotation(
            component="ReferenceEditQuantity",
            label="GrowthMovpe1IMEMConstantParameters Reference",
        ),
    )
