...
from nomad.datamodel.data import EntryData, ArchiveSection, Author, EntryDataCategory
...
class Users(ArchiveSection):
    ...
    user = Quantity(
        type=Author,
        description='FILL',
        a_tabular={'name': 'Overview/Operator'},
...
class Dopants(ElementalComposition):
    ...
    doping_level = Quantity(
        ...
        a_tabular={'name': 'Substrate/Doping Level'},
    )
    element = Quantity(
        type=str,
...
class Parallelepiped(ArchiveSection):
    ...
    width = Quantity(
        ...
        a_tabular={'name': 'Substrate/Size X'},
        unit='millimeter',
    )
    length = Quantity(
        type=np.float64,
        ...
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'millimeter'},
        a_tabular={'name': 'Substrate/Size Y'},
        unit='millimeter',
    )
...
class Cylinder(ArchiveSection):
    ...
    lower_cap_radius = Quantity(
        ...
        # unit="inch",
        a_tabular={'name': 'Substrate/Size Diameter'},
    )
...
class Precursor(PureSubstance, EntryData):
    ...
    name = Quantity(
        type=str,
        description='FILL',
        a_eln={'component': 'StringEditQuantity', 'label': 'Substance Name'},
    )
    cas_number = Quantity(
        type=str,
        description='FILL',
        a_eln={'component': 'StringEditQuantity', 'label': 'CAS number'},
    ...
    phase = Quantity(
        ...
        a_tabular={'name': 'Precursors/Phase'},
    )
    description = Quantity(
        ...
        a_tabular={'name': 'Precursors/Description'},
    )
    supplier = Quantity(
        type=str,
        description='FILL',
        ...
        a_tabular={'name': 'Precursors/Supplier'},
    )
    buying_date = Quantity(
        ...
        a_tabular={'name': 'Precursors/Buying date'},
    )
    opening_date = Quantity(
        ...
        a_tabular={'name': 'Precursors/Opening date'},
    )
    notes = Quantity(
        type=str,
        description='FILL',
        ...
        a_tabular={'name': 'Precursors/Notes'},
    )
...
class Substrate(CompositeSystem, EntryData):
    ...
    m_def = Section(label_quantity='lab_id', categories=[IMEMMOVPECategory])

    alias = Quantity(
        type=str,
        description='FILL',
        a_eln={'component': 'StringEditQuantity'},
        a_tabular={'name': 'Substrate/Substrate ID'},
    )
    name = Quantity(
        type=str,
        description='FILL',
        a_eln={'component': 'StringEditQuantity'},
        a_tabular={'name': 'Substrate/Material'},
    )
    lab_id = Quantity(
        type=str,
        description='FILL',
    ...
    off_cut = Quantity(
        ...
        a_eln={'component': 'NumberEditQuantity'},
        a_tabular={'name': 'Substrate/Off-cut'},
    )
    off_cut_orientation = Quantity(
        type=str,
        description='orientation of Off-cut angle to the substrates surface',
        a_eln={'component': 'StringEditQuantity'},
        a_tabular={'name': 'Substrate/Off-cut Orientation'},
    )
    susceptor = Quantity(
        type=str,
        description='FILL',
        a_eln={'component': 'StringEditQuantity'},
        a_tabular={'name': 'Substrate/Susceptor'},
    )
    mask = Quantity(
        type=str,
        description='FILL',
        a_eln={'component': 'StringEditQuantity'},
        a_tabular={'name': 'Substrate/Mask'},
    )
    pocket = Quantity(
        type=str,
        description='FILL',
        a_eln={'component': 'StringEditQuantity'},
        a_tabular={'name': 'Substrate/Pocket'},
    )
    annealing = Quantity(
        type=bool,
    ...
    cleaning = Quantity(
        ...
        description='FILL',
        a_eln={'component': 'BoolEditQuantity'},
        a_tabular={'name': 'Substrate/Cleaning'},
    )
    regrowth = Quantity(
        type=bool,
        description='FILL',
        a_eln={'component': 'BoolEditQuantity'},
        a_tabular={'name': 'Substrate/Regrowth'},
    )
    notes = Quantity(
...
class GrownSample(CompositeSystem, EntryData):
    ...
    m_def = Section(more={'label_quantity': 'lab_id'}, categories=[IMEMMOVPECategory])

    lab_id = Quantity(
        type=str,
        description='the sample used for this step of growth',
        a_eln={'label': 'Sample ID'},
    )
...
class GrownSamples(CompositeSystemReference):
    ...
    lab_id = Quantity(
        ...
        a_tabular={'name': 'Overview/Sample'},
        a_eln=ELNAnnotation(
            component='StringEditQuantity',
...
class Bubblers(ArchiveSection):
    ...
    flow_carrier = Quantity(
        type=np.float64,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/Flow Carrier'},
        a_eln={
            'component': 'NumberEditQuantity',
            'defaultDisplayUnit': 'cm ** 3 / minute',
        },
    ...
    valve = Quantity(
        ...
        a_tabular={'name': 'GrowthRun/Bubbler Valve'},
        a_eln={'component': 'BoolEditQuantity'},
    )
...
class GasSource(ArchiveSection):
    ...
    material = Quantity(
        type=str,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/Gas Cylinder Material'},
        a_eln={'component': 'StringEditQuantity'},
    )
    dilution_in_cylinder = Quantity(
        type=np.float64,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/Dilution in Cylinder'},
        a_eln={'component': 'NumberEditQuantity'},
    )
    flow_from_mfc = Quantity(
        type=np.float64,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/Flow from MFC'},
        a_eln={
            'component': 'NumberEditQuantity',
            'defaultDisplayUnit': 'cm ** 3 / minute',
        },
    ...
    effective_flow = Quantity(
        type=np.float64,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/Effective Flow'},
        a_eln={
            'component': 'NumberEditQuantity',
            'defaultDisplayUnit': 'cm ** 3 / minute',
        },
    ...
    partial_pressure = Quantity(
        type=np.float64,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/Gas Partial Pressure'},
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'mbar'},
        unit='mbar',
    )
    cylinder_pressure = Quantity(
        type=np.float64,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/Cylinder Pressure'},
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'mbar'},
        unit='mbar',
    )
    valve = Quantity(
        type=bool,
        description='is valve open? True/False',
        a_tabular={'name': 'GrowthRun/Gas Valve'},
        a_eln={'component': 'BoolEditQuantity'},
    )
...
class MistSourceComponents(ArchiveSection):
    ...
    material = Quantity(
        ...
        description='FILL',
        a_eln={'component': 'StringEditQuantity'},
        a_tabular={'name': 'Mist/Material'},
    )
    concentration = Quantity(
        type=np.float64,
        description='FILL',
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplyUnit': 'mol / liter'},
        a_tabular={'name': 'Mist/Concentration'},
        unit='mol / liter',
    )
...
class MIST(Instrument, EntryData):
    ...
    m_def = Section(more={'label_quantity': 'item'}, categories=[IMEMMOVPECategory])

    item = Quantity(
        type=str,
        description='FILL',
        a_tabular={'name': 'Mist/Item'},
        a_eln={'component': 'StringEditQuantity'},
    )
    temperature = Quantity(
        type=np.float64,
        description='FILL',
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplyUnit': 'celsius'},
        a_tabular={'name': 'Mist/Temperature'},
        unit='celsius',
    )
    time = Quantity(
        type=np.float64,
        description='FILL',
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplyUnit': 'minute'},
        a_tabular={'name': 'Mist/Time'},
        unit='minute',
    )
    notes = Quantity(
        type=str,
        description='FILL',
        a_tabular={'name': 'Mist/Notes'},
        a_eln={'component': 'StringEditQuantity'},
    )
...
class MistSource(ArchiveSection):
    ...
    name = Quantity(
        type=str,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/MIST Source 1'},
        a_eln={'component': 'StringEditQuantity'},
    )
    flow = Quantity(
        type=np.float64,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/MIST Flow MFC'},
        a_eln={
            'component': 'NumberEditQuantity',
            'defaultDisplayUnit': 'cm ** 3 / minute',
        },
    ...
    valve = Quantity(
        type=bool,
        description='is valve open? True/False',
        a_tabular={'name': 'GrowthRun/MIST Valve'},
        a_eln={'component': 'BoolEditQuantity'},
    )
...
class PregrowthStep(ProcessStep):
    ...
    step_number = Quantity(
        ...
        a_eln={'component': 'NumberEditQuantity'},
        a_tabular={'name': 'Pregrowth/Step Index'},
    )
    name = Quantity(
        type=str,
        description='what this step consists of',
        a_tabular={'name': 'Pregrowth/Step Name'},
        a_eln={'component': 'StringEditQuantity'},
    )
    description = Quantity(
        type=str,
        description='FILL',
        a_tabular={'name': 'Pregrowth/Description'},
        a_eln={'component': 'StringEditQuantity'},
    )
    elapsed_time = Quantity(
        ...
        description='FILL',
        a_eln={'component': 'NumberEditQuantity'},
        a_tabular={'name': 'Pregrowth/Duration'},
        unit='minute',
    )
    carrier_gas_flow = Quantity(
        ...
        a_tabular={'name': 'Pregrowth/Carrier Gas Flow'},
        unit='cm ** 3 / minute',
    )
    ...
    chamber_pressure = Quantity(
        ...
        description='FILL',
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'mbar'},
        a_tabular={'name': 'Pregrowth/Chamber Pressure'},
        unit='mbar',
    )
    substrate_temperature = Quantity(
        type=np.float64,
        description='FILL',
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'celsius'},
        a_tabular={'name': 'Pregrowth/Substrate Temperature'},
        unit='celsius',
    )
    carrier_rotation = Quantity(
        ...
        a_tabular={'name': 'Pregrowth/Carrier Rotation'},
        unit='rpm',
    )
    notes = Quantity(
        type=str,
        description='FILL',
        a_tabular={'name': 'Pregrowth/Notes'},
        a_eln={'component': 'StringEditQuantity'},
    )
...
class GrowthRunStep(ProcessStep):
    ...
    step_number = Quantity(
        type=int,
        description='sequential number of the step on going',
        a_tabular={'name': 'GrowthRun/Step'},
        a_eln={'component': 'NumberEditQuantity'},
    )
    temperature = Quantity(
        type=np.float64,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/Temperature'},
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'celsius'},
        unit='celsius',
    )
    pressure = Quantity(
    ...
    metal_carrier_flow = Quantity(
        type=np.float64,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/Flow Metal Carrier'},
        a_eln={
            'component': 'NumberEditQuantity',
            'defaultDisplayUnit': 'cm ** 3 / minute',
        },
    ...
    metal_inner_valve = Quantity(
        ...
        a_tabular={'name': 'GrowthRun/Metal Inner Valve'},
        a_eln={'component': 'SliderEditQuantity', 'minValue': 0, 'maxValue': 200},
    )
    metal_outer_valve = Quantity(
        type=int,
        description='inner valve (0-200)',
        a_tabular={'name': 'GrowthRun/Metal Outer Valve'},
        a_eln={'component': 'SliderEditQuantity', 'minValue': 0, 'maxValue': 200},
    )
    oxydant_carrier_flow = Quantity(
        type=np.float64,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/Flow Oxydant Carrier'},
        a_eln={
            'component': 'NumberEditQuantity',
            'defaultDisplayUnit': 'cm ** 3 / minute',
        },
    ...
    oxydant_inner_valve = Quantity(
        type=int,
        description='inner valve (0-200)',
        a_tabular={'name': 'GrowthRun/Oxydant Inner Valve'},
        a_eln={'component': 'SliderEditQuantity', 'minValue': 0, 'maxValue': 200},
    )
    oxydant_outer_valve = Quantity(
        type=int,
        description='inner valve (0-200)',
        a_tabular={'name': 'GrowthRun/Oxydant Outer Valve'},
        a_eln={'component': 'SliderEditQuantity', 'minValue': 0, 'maxValue': 200},
    )
    purge_flow = Quantity(
        type=np.float64,
        description='FILL THE DESCRIPTION',
        a_tabular={'name': 'GrowthRun/Purge Flow'},
        a_eln={
            'component': 'NumberEditQuantity',
            'defaultDisplayUnit': 'cm ** 3 / minute',
        },
    ...
    purge_valve = Quantity(
        type=int,
        description='inner valve (0-200)',
        a_tabular={'name': 'GrowthRun/Purge Valve'},
        a_eln={'component': 'SliderEditQuantity', 'minValue': 0, 'maxValue': 200},
    )
...
class GrowthRun(Process, EntryData, TableData):
    ...
    lab_id = Quantity(
        ...
        a_eln={'component': 'StringEditQuantity', 'label': 'Growth ID'},
    )
    steps = SubSection(
...
class AFMmeasurement(Measurement, EntryData):
    ...
    roughness = Quantity(
        ...
        a_tabular={'name': 'AFMReflectanceSEM/Roughness'},
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'nanometer'},
        unit='nanometer',
    )
    surface_features = Quantity(
        type=str,
        a_tabular={'name': 'AFMReflectanceSEM/Surface Features'},
        a_eln={'component': 'StringEditQuantity'},
    )
...
class ReflectanceMeasurement(Measurement, EntryData):
    ...
    description = Quantity(
        type=str,
        description='Notes and comments.',
        a_tabular={'name': 'AFMReflectanceSEM/Notes'},
        a_eln={'component': 'StringEditQuantity', 'label': 'Notes'},
        default='#data/SEM/description',
    )
    image = Quantity(
    ...
    thickness = Quantity(
        ...
        a_tabular={'name': 'AFMReflectanceSEM/Thickness'},
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'nanometer'},
        unit='nanometer',
    )
    growth_rate = Quantity(
        ...
        a_tabular={'name': 'AFMReflectanceSEM/Growth Rate'},
        a_eln={
            'component': 'NumberEditQuantity',
...
class UVAbsorbanceMeasurement(Measurement, EntryData):
    ...
    sample_id = Quantity(
        type=str,
        a_tabular={'name': 'ElectroOptical/Sample'},
        a_eln={'component': 'StringEditQuantity'},
    )
    datetime = Quantity(
        type=Datetime,
        a_tabular={'name': 'ElectroOptical/Date'},
        a_eln={'component': 'DateTimeEditQuantity'},
    )
    energy_gap = Quantity(
        type=np.float64,
        description='FILL',
        a_tabular={'name': 'ElectroOptical/Energy Gap ABS'},
    ...
    abs_coefficient = Quantity(
        type=np.float64,
        description='FILL',
        a_tabular={'name': 'ElectroOptical/ABS coefficient'},
    ...
    thickness = Quantity(
        ...
        a_tabular={'name': 'ElectroOptical/Thickness'},
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'nanometer'},
        unit='nanometer',
    )
...
class Other(Measurement, EntryData):
    ...
    energy_gap_PC = Quantity(
        ...
        a_tabular={'name': 'ElectroOptical/Energy Gap PC'},
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'eV'},
        unit='eV',
        categories=[IMEMMOVPECategory],
    )
    responsivity = Quantity(
        type=np.float64,
        description='FILL',
        a_tabular={'name': 'ElectroOptical/Responsivity'},
        a_eln={
            'component': 'NumberEditQuantity',
    ...
    rejection_ratio = Quantity(
        ...
        a_tabular={'name': 'ElectroOptical/Rejection Ratio'},
        a_eln={'component': 'NumberEditQuantity'},
    )
...
class HRXRDmeasurement(Measurement, EntryData):
    ...
    sample_id = Quantity(
        type=str,
        a_tabular={'name': 'HRXRD/Sample'},
        a_eln={'component': 'StringEditQuantity'},
    )
    datetime = Quantity(
        type=Datetime,
        a_tabular={'name': 'HRXRD/Date'},
        a_eln={'component': 'DateTimeEditQuantity'},
    )
    phase = Quantity(
        type=str,
        description='Phase type obtained from HRXRD',
        a_tabular={'name': 'HRXRD/Phase'},
        a_eln={'component': 'StringEditQuantity'},
    )
    peak_position_2theta = Quantity(
        type=np.float64,
        description='Peak Position - 2theta',
        a_tabular={'name': 'HRXRD/Peak Position - 2theta'},
    ...
    peak_fwhm_2theta = Quantity(
        type=np.float64,
        description='Peak Position - 2theta',
        a_tabular={'name': 'HRXRD/Peak FWHM - 2theta'},
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'degree'},
        unit='degree',
    )
    peak_position_omega = Quantity(
        ...
        a_tabular={'name': 'HRXRD/Peak Position - Omega'},
        a_eln={'component': 'NumberEditQuantity', 'defaultDisplayUnit': 'degree'},
        unit='degree',
    )
    peak_fwhm_rocking_curve = Quantity(
        ...
        a_tabular={'name': 'HRXRD/Peak FWHM Rocking Curve'},
        a_eln={'component': 'StringEditQuantity'},
    )
    reflection = Quantity(
        type=str,
        description='Peak FWHM Rocking Curve',
        a_tabular={'name': 'HRXRD/Reflection'},
        a_eln={'component': 'StringEditQuantity'},
    )
...
class SamplesToCut(CompositeSystemReference):
    ...
    lab_id = Quantity(
        ...
        a_tabular={'name': 'SampleCut/Parent Sample ID'},
        a_eln=ELNAnnotation(
            component='StringEditQuantity',
            label='Grown Sample ID',
        ),
...
class ChildrenSamples(CompositeSystemReference):
    ...
    lab_id = Quantity(
        ...
        a_tabular={'name': 'SampleCut/Children Sample ID'},
        a_eln=ELNAnnotation(
            component='StringEditQuantity',
...
class SampleCutting(Process, EntryData):
    ...
    m_def = Section(a_eln=None, categories=[IMEMMOVPECategory])
    method = Quantity(
        type=str,
    ...
    cut_date = Quantity(
        type=Datetime,
        description='FILL',
        a_tabular={'name': 'SampleCut/Cut Date'},
        a_eln={'component': 'DateTimeEditQuantity'},
    )
    position = Quantity(
        type=str,
        description='FILL',
        a_tabular={'name': 'SampleCut/Position'},
        a_eln={'component': 'StringEditQuantity'},
    )
    purpose = Quantity(
        type=str,
        description='FILL',
        a_tabular={'name': 'SampleCut/Experiment'},
        a_eln={'component': 'StringEditQuantity'},
    )
    size = Quantity(
        type=np.float64,
        ...
        a_tabular={'name': 'SampleCut/Size'},
        unit='millimeter ** 2',
    )
    collaborator = Quantity(
        type=str,
        description='FILL',
        a_tabular={'name': 'SampleCut/Collaborator'},
        a_eln={'component': 'StringEditQuantity'},
    )
    ...
    children_sample = SubSection(section_def=ChildrenSamples, repeats=True)
...
class ContactSputtering(Process, EntryData):
    ...
    name = Quantity(
        type=str,
        description='FILL',
        a_tabular={'name': 'Contacts/Sample Piece'},
        a_eln={'component': 'StringEditQuantity'},
    )
    datetime = Quantity(
        type=Datetime,
        description='FILL',
        a_tabular={'name': 'Contacts/Deposition Date'},
        a_eln={'component': 'DateTimeEditQuantity', 'label': 'deposition_date'},
    )
    contact_type = Quantity(
        type=str,
        description='FILL',
        a_tabular={'name': 'Contacts/Contact Type'},
        a_eln={'component': 'StringEditQuantity'},
    )
    contact_geometry = Quantity(
        type=str,
        description='FILL',
        a_tabular={'name': 'Contacts/Geometry'},
        a_eln={'component': 'StringEditQuantity'},
    )
...
class MovpeIMEMExperiment(Experiment, EntryData, TableData):
    ...
    m_def = Section(a_eln={'hide': ['steps']}, categories=[IMEMMOVPECategory])
    data_file = Quantity(
        type=str,
        description='Upload here the spreadsheet file containing the growth data',
        a_tabular_parser={
    ...
    carrier_gas = Quantity(type=str, a_eln={'component': 'StringEditQuantity'})
    ...
    substrates = SubSection(section_def=Substrates, repeats=True)
    grown_samples = SubSection(section_def=GrownSamples, repeats=True)
    parent_sample = SubSection(section_def=ParentSamples, repeats=True)
    mist = SubSection(section_def=MISTs, repeats=True)
    pregrowth = SubSection(section_def=Pregrowths)
    growth_run = SubSection(section_def=GrowthRuns)
